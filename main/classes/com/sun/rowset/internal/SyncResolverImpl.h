#ifndef _com_sun_rowset_internal_SyncResolverImpl_h_
#define _com_sun_rowset_internal_SyncResolverImpl_h_
//$ class com.sun.rowset.internal.SyncResolverImpl
//$ extends com.sun.rowset.CachedRowSetImpl
//$ implements javax.sql.rowset.spi.SyncResolver
...
class SyncResolverImpl : public ::com::sun::rowset::CachedRowSetImpl, public ::javax::sql::rowset::spi::SyncResolver {
...
public:
	...
	::javax::sql::rowset::CachedRowSet* buildCachedRow();
	...
	virtual $Object* getConflictValue(int32_t index) override;
	virtual $Object* getConflictValue($String* columnName) override;
	virtual ::java::sql::Connection* getConnection() override;
	virtual ::com::sun::rowset::internal::BaseRow* getCurrentRow() override;
	...
	virtual bool nextConflict() override;
	...
	virtual bool previousConflict() override;
	...
	virtual void removeCurrentRow() override;
	...
	virtual void setCachedRowSet(::javax::sql::rowset::CachedRowSet* crs);
	virtual void setCachedRowSetResolver(::javax::sql::rowset::CachedRowSet* crs);
	virtual void setCachedRowSetWriter(::com::sun::rowset::internal::CachedRowSetWriter* CRWriter);
	...
	virtual void setOriginal() override;
	...
	virtual void setResolvedValue(int32_t index, Object$* obj) override;
	virtual void setResolvedValue($String* columnName, Object$* obj) override;
	...
	virtual void setStatus(::java::util::ArrayList* status);
	...
	virtual void updateNCharacterStream(int32_t columnIndex, ::java::io::Reader* x, int32_t length);
	virtual void updateNCharacterStream($String* columnName, ::java::io::Reader* x, int32_t length);
	...
	void writeData(::javax::sql::rowset::CachedRowSet* row);
	::com::sun::rowset::CachedRowSetImpl* crsRes = nullptr;
	::com::sun::rowset::CachedRowSetImpl* crsSync = nullptr;
	::java::util::ArrayList* stats = nullptr;
	::com::sun::rowset::internal::CachedRowSetWriter* crw = nullptr;
	int32_t rowStatus = 0;
	int32_t sz = 0;
...
#endif // _com_sun_rowset_internal_SyncResolverImpl_h_