#ifndef _com_sun_rowset_JoinRowSetImpl_h_
#define _com_sun_rowset_JoinRowSetImpl_h_
//$ class com.sun.rowset.JoinRowSetImpl
...
class JoinRowSetImpl : public ::com::sun::rowset::WebRowSetImpl, public ::javax::sql::rowset::JoinRowSet {
...
public:
	...
	virtual void addRowSet(::javax::sql::rowset::Joinable* rowset) override;
	virtual void addRowSet(::javax::sql::RowSet* rowset, int32_t columnIdx) override;
	virtual void addRowSet(::javax::sql::RowSet* rowset, $String* columnName) override;
	virtual void addRowSet($Array<::javax::sql::RowSet>* rowset, $ints* columnIdx) override;
	virtual void addRowSet($Array<::javax::sql::RowSet>* rowset, $StringArray* columnName) override;
	...
	bool checkforMatchColumn(::javax::sql::rowset::Joinable* rs);
	virtual void clearWarnings() override;
	virtual void close() override;
	virtual bool columnUpdated(int32_t indexColumn) override;
	...
	virtual ::java::sql::Array* getArray($String* columnName) override;
	...
	virtual ::java::sql::Blob* getBlob($String* columnName) override;
	...
	virtual ::java::sql::Clob* getClob($String* columnName) override;
	...
	virtual int32_t getJoinType() override;
	...
	virtual ::java::sql::Ref* getRef($String* columnName) override;
	virtual int32_t getRow() override;
	virtual $StringArray* getRowSetNames() override;
	virtual ::java::util::Collection* getRowSets() override;
	...
	virtual $String* getWhereClause() override;
	void initJOIN(::javax::sql::rowset::CachedRowSet* rowset);
	...
	virtual void setJoinType(int32_t type) override;
	virtual void setKeyColumns($ints* cols) override;
	...
	virtual bool supportsCrossJoin() override;
	virtual bool supportsFullJoin() override;
	virtual bool supportsInnerJoin() override;
	virtual bool supportsLeftOuterJoin() override;
	virtual bool supportsRightOuterJoin() override;
	virtual ::javax::sql::rowset::CachedRowSet* toCachedRowSet() override;
	...
	virtual void updateCharacterStream($String* columnName, ::java::io::Reader* x, int32_t length) override;
	...
	::java::util::Vector* vecRowSetsInJOIN = nullptr;
	::com::sun::rowset::CachedRowSetImpl* crsInternal = nullptr;
	::java::util::Vector* vecJoinType = nullptr;
	::java::util::Vector* vecTableNames = nullptr;
	int32_t iMatchKey = 0;
...
#endif // _com_sun_rowset_JoinRowSetImpl_h_