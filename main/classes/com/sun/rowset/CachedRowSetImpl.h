#ifndef _com_sun_rowset_CachedRowSetImpl_h_
#define _com_sun_rowset_CachedRowSetImpl_h_
//$ class com.sun.rowset.CachedRowSetImpl
//$ extends javax.sql.rowset.BaseRowSet
//$ implements javax.sql.RowSetInternal,javax.sql.rowset.CachedRowSet
...
#pragma push_macro("DEFAULT_SYNC_PROVIDER")
#undef DEFAULT_SYNC_PROVIDER
#pragma push_macro("RSMD")
#undef RSMD
...
class CachedRowSetImpl : public ::javax::sql::rowset::BaseRowSet, public ::javax::sql::RowSetInternal, public ::javax::sql::rowset::CachedRowSet {
...
public:
	...
	virtual $ObjectArray* getParams() override;
	...
	void checkCursor();
	void checkIndex(int32_t idx);
	void checkTransactionalWriter();
	...
	$Object* convertBoolean(Object$* srcObj, int32_t srcType, int32_t trgType);
	$Object* convertNumeric(Object$* srcObj, int32_t srcType, int32_t trgType);
	$Object* convertTemporal(Object$* srcObj, int32_t srcType, int32_t trgType);
	...
	void establishTransactionalWriter();
	...
	int32_t getColIdxByName($String* name);
	virtual ::java::sql::Connection* getConnection() override;
	...
	void initContainer();
	void initMetaData(::javax::sql::rowset::RowSetMetaDataImpl* md, ::java::sql::ResultSetMetaData* rsmd);
	void initProperties();
	virtual void insertRow() override;
	virtual bool internalFirst();
	virtual bool internalLast();
	virtual bool internalNext();
	virtual bool internalPrevious();
	virtual bool isAfterLast() override;
	virtual bool isBeforeFirst() override;
	bool isBinary(int32_t type);
	bool isBoolean(int32_t type);
	virtual bool isClosed() override;
	virtual bool isFirst() override;
	virtual bool isLast() override;
	bool isNumeric(int32_t type);
	virtual bool isReadOnly() override;
	bool isString(int32_t type);
	bool isTemporal(int32_t type);
	virtual bool isWrapperFor($Class* interfaces) override;
	virtual bool last() override;
	void makeRowOriginal(::com::sun::rowset::internal::Row* row);
	...
	void setLastValueNull(bool value);
	...
	virtual void setRowInserted(bool insertFlag);
	...
	using ::javax::sql::rowset::CachedRowSet::updateObject;
	...
	::javax::sql::RowSetReader* rowSetReader = nullptr;
	::javax::sql::RowSetWriter* rowSetWriter = nullptr;
	::java::sql::Connection* conn = nullptr;
	::java::sql::ResultSetMetaData* RSMD = nullptr;
	::javax::sql::rowset::RowSetMetaDataImpl* RowSetMD = nullptr;
	$ints* keyCols = nullptr;
	$String* tableName = nullptr;
	::java::util::Vector* rvh = nullptr;
	int32_t cursorPos = 0;
	int32_t absolutePos = 0;
	int32_t numDeleted = 0;
	int32_t numRows = 0;
	::com::sun::rowset::internal::InsertRow* insertRow$ = nullptr;
	bool onInsertRow = false;
	int32_t currentRow = 0;
	bool lastValueNull = false;
	::java::sql::SQLWarning* sqlwarn = nullptr;
	$String* strMatchColumn = nullptr;
	int32_t iMatchColumn = 0;
	::javax::sql::rowset::RowSetWarning* rowsetWarning = nullptr;
	$String* DEFAULT_SYNC_PROVIDER = nullptr;
	bool dbmslocatorsUpdateCopy = false;
	::java::sql::ResultSet* resultSet = nullptr;
	int32_t endPos = 0;
	int32_t prevEndPos = 0;
	int32_t startPos = 0;
	int32_t startPrev = 0;
	int32_t pageSize = 0;
	int32_t maxRowsreached = 0;
	bool pagenotend = false;
	bool onFirstPage = false;
	bool onLastPage = false;
	int32_t populatecallcount = 0;
	int32_t totalRows = 0;
	bool callWithCon = false;
	::com::sun::rowset::internal::CachedRowSetReader* crsReader = nullptr;
...
#pragma pop_macro("DEFAULT_SYNC_PROVIDER")
#pragma pop_macro("RSMD")

#endif // _com_sun_rowset_CachedRowSetImpl_h_